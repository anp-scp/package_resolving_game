...
def create_interactive_graph(game):
    ...
    # Group edges by source node for overlap detection
    edges_by_source = {}
    for edge in G.edges():
        source = edge[0]
    ...
    # Process each group of edges from the same source
